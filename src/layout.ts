...
export const SHARED_STYLES = `
  ...
  * { box-sizing: border-box; }
  ...
  .stat-tile-clickable { cursor: pointer; text-decoration: none; transition: border-color 0.15s ease; }
...
<link href="https://fonts.googleapis.com/css2?family=Big+Shoulders+Display:wght@600;700;800&family=Inter:wght@400;500;600&family=IBM+Plex+Mono:wght@400;500;600&family=Playfair+Display:wght@400;700&family=Merriweather:wght@400;700&display=swap" rel="stylesheet">
